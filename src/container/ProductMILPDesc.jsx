...
import Gambar from '../assets/image/gambar15.jpg';
import { Link } from 'react-router-dom';
import Aos from 'aos'

const ProductMILPDesc = () => {
    useEffect(() => {
        Aos.init({});
    })
  return (
    <div id="About" className="container lg:pt-0 bg-[#DFDFDF]">
        <div className="flex flex-wrap">
            ...
            <div className="px-10 lg:pb-24 lg:pl-12 lg:w-1/2 lg:pt-24" data-aos="fade-up" data-aos-duration="3000">
                <p className='font-bold text-[#e52a37] text-left text-2xl mb-5 lg:text-4xl'>Loan Collection System</p>
                <p className='font-medium text-dark text-justify mb-10 leading-relaxed'>A "Loan Collection System" is a specialized software system or platform used by financial institutions and lenders to efficiently manage and automate the process of collecting repayments from borrowers. It plays a crucial role in overseeing the repayment of loans and helps ensure that borrowers meet their payment obligations according to the terms of their loan agreements.</p>
...
export default ProductMILPDesc;