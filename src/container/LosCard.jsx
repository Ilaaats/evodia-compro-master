...
import LosCardComp from '../component/LosCardComp';

class LosCard extends Component {
    state = { } 
    render() { 
        const data = [
            {
            ...
            {
                img: enterprise_img,
                title:'Loan Transaction & Monitoring System',
        ...
        ( ({img, title, desc, duration, redirect}) => {
            return <LosCardComp key={title} img={img} title={title} desc={desc} duration={duration} redirect={redirect}/>
        })
        return (
            <div id="our-business" className="p-12">
                <p className='text-4xl font-bold text-[#e52a37] text-center py-20' data-aos="fade-up" data-aos-duration="3000">ILP Product</p>
