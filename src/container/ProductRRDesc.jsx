...
import Gambar from '../assets/image/gambar6.jpg';
    ...
    <div id="About" className="container lg:pt-0 bg-[#DFDFDF]">
        <div className="flex flex-wrap">
            ...
            <div className="px-10 lg:pb-24 lg:pl-12 lg:w-1/2 lg:pt-24" data-aos="fade-up" data-aos-duration="3000">
                <p className='font-bold text-[#e52a37] text-left text-2xl mb-5 lg:text-4xl'>OBox OJK-BOX</p>
                <p className='font-medium text-dark text-justify mb-10 leading-relaxed'>BI Antasena is an integrated reporting system built jointly by BI, OJK and LPS. This reporting system integrates 6 existing reports (LBU, LSMK, LBBUK, LBBUS, LHBU, and LKPBU) and is metadata-based.</p>
