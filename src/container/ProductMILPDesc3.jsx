...
import Gambar from '../assets/image/gambar14.jpg';
import { Link } from 'react-router-dom';
import Aos from 'aos'

const ProductMILPDesc3 = () => {
    useEffect(() => {
        Aos.init({});
    })
  return (
    <div id="About" className="container lg:pt-0">
        <div className="flex flex-wrap">
            ...
            <div className="px-10 lg:pb-24 lg:pl-12 lg:w-1/2 lg:pt-24" data-aos="fade-up" data-aos-duration="3000">
                <p className='font-bold text-[#e52a37] text-left text-2xl mb-5 lg:text-4xl'>PayLater System</p>
                <p className='font-medium text-dark text-justify mb-10 leading-relaxed'>A "PayLater system" typically refers to a financial service or feature that allows consumers to make purchases and defer the payment to a later date. It is a form of credit or financing that enables individuals to access goods or services immediately and pay for them at a later time.</p>
...
export default ProductMILPDesc3;