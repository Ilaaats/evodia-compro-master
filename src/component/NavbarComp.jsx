                        ...
                        <div className='flex flex-col lg:items-center lg:flex-row lg:justify-between'>
                            ...
                            <div className="hidden lg:flex gap-12 font-medium">
                                ...
                                <div className="group relative">
                                    ...
                                    <Link to="/ILP" className="px-5 py-2 hover:text-[#e52a37]">Integrated Loan Processing</Link>
                                        <Link to="/MILP" className="px-5 py-2 hover:text-[#e52a37]">Mobile Integrated Loan Processing</Link>
                                        <Link to="/RR" className="px-5 py-2 hover:text-[#e52a37]">Regulatory Reporting</Link>
                                        {/* <Link to="/enterprise-level" className="px-5 py-2 hover:text-[#e52a37]">Enterprise Level</Link> */}
                                        
                                        <Link to="/financial-solutions" className="px-5 py-2 hover:text-[#e52a37]">Financial Solutions</Link>
